...
public class ErikblueEntity extends PathfinderMob {
	public ErikblueEntity(EntityType<ErikblueEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(true);
	...
	protected void dropCustomDeathLoot(ServerLevel serverLevel, DamageSource source, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(ErikmodModItems.ERIKBLUE_SPAWN_EGG.get()));
	}
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata) {
		...
		ErikblueOnInitialEntitySpawnProcedure.execute(world, this.getX(), this.getY(), this.getZ(), this);
		return retval;
	}
	...
	public void baseTick() {
		super.baseTick();
		ErikblueOnEntityTickUpdateProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}
