...
public class CavarliModItems {
	...
	public static final DeferredItem<Item> ANGRY_FUO_BLOCK = block(CavarliModBlocks.ANGRY_FUO_BLOCK);
	public static final DeferredItem<Item> TTRS_BLOCK = block(CavarliModBlocks.TTRS_BLOCK);
