...
public class JakyChairEntity extends PathfinderMob {
	public JakyChairEntity(EntityType<JakyChairEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(true);
	...
	protected void dropCustomDeathLoot(ServerLevel serverLevel, DamageSource source, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(SomethingModItems.JAKY_CHAIR_SPAWN_EGG.get()));
	}
