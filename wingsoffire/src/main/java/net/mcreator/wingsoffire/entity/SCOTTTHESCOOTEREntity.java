...
public class SCOTTTHESCOOTEREntity extends PathfinderMob {
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		SCOTTTHESCOOTERRightClickedOnEntityProcedure.execute(entity, sourceentity);
		return retval;
	}

	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(WingsoffireModEntities.SCOTTTHESCOOTER.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
