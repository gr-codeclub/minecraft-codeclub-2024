...
import net.mcreator.oogaboogablockgen.procedures.ChairOnInitialEntitySpawnProcedure;
...
public class ChairEntity extends PathfinderMob {
	...
	protected void dropCustomDeathLoot(ServerLevel serverLevel, DamageSource source, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(OogaboogablockgenModItems.CHAIR_SPAWN_EGG.get()));
	}
